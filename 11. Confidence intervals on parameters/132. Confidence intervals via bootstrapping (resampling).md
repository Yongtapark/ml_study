...
- 원본 표본에서 데이터 포인트를 무작위로 선택하여 기록 -> 부트스트랩 데이터셋
	...
	- 하지만 적절한 크기의 표본 데이터셋을 가지고 있다면, 원본 표본과 동일한 크기를 가지는것이 일반적임
		...
		$\textcolor[rgb]{1, 0.6, 0.2}{y_1,y_2,...,y_{500}}$
			⇩
![[../pic/11.Confidence intervals on parameters/132.Pasted image 20240917100507.png]]
- 부트스트랩 데이터들의 평균을 이용하여 분포를 계산
	- 대수의 법칙에 의해 원본 파라미터의 파라미터는 대략적으로 중심에 존재
- 이제 우리가 신뢰구간을 계산할 수 있는 경험적 분포가 완성됨.
![[../pic/11.Confidence intervals on parameters/132.Pasted image 20240917100828.png]]

---
### Parametric vs. nonparametric C.I

![[../pic/11.Confidence intervals on parameters/132.Pasted image 20240917101007.png]]
parametric
...
plt.show()
```
![[../pic/11.Confidence intervals on parameters/132.Pasted image 20240917114257.png]]
...
plt.show()
```
![[../pic/11.Confidence intervals on parameters/132.Pasted image 20240917130025.png]]
