...
![[../pic/6.descriptive statistics/46.concept_of_dispersion.png]]
...
![[../pic/6.descriptive statistics/46.visualize_variance.png]]
...
plt.show()
```
![[../pic/6.descriptive statistics/46.standard_division.png]]
...
plt.show()
```
![[../pic/6.descriptive statistics/46.variance_and_std_MAD.png]]
...
```
#### Passion -> poisson
![[../pic/6.descriptive statistics/46.poisson.png]]
...
plt.show()
```
![[../pic/6.descriptive statistics/46.fano_factor_cv_poisson.png]]